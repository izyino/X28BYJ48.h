...
// Rede Wi-Fi criada com o nome X28BYJ48 senha 00000000, acessível
...
X28BYJ48 motor(2); // indica motor de passo no modo 2 em CN1 e motor(es) DC em CN2

const char *ssid = "X28BYJ48";
...
<body>
  <div class="cabec">
    <h1>Exemplo de uso da biblioteca X28BYJ48.h</h1>
  </div>
  <div class="conteudo">
    <div class="cartao">
    <form action="">
...
void setup()
{
  ...
  delay(500);
  motor.begin();
  Serial.println("Ativando o modo soft access point");
