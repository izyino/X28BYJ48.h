...
// X28BYJ48 com a senha 00000000. Acessar então o IP 192.168.4.1
...
String html="<html><head><meta charset='utf-8'><title></title></head><body><table border='0' width='600' id='table1' cellspacing='4' cellpadding='8' height='400'><tr><td colspan='6' align='center' bgcolor='#CCFF99'><p align='center'><b><font size='4'>CONTROLE DO MOTOR DE PASSO<br>PARA TESTE DA PCI CTRL-28BYJ48 VIA Wi-Fi<br></font><font color='#0000FF' size='2'>hh:mm:ss</font></b></p></td></tr><tr><td colspan='6' align='center'>&nbsp;</td></tr><tr><td colspan='6' align='center' bgcolor='#FFCCFF'><font size='2'><b>VELOCIDADE (RPM)</b></font></td></tr><tr><td align='center' bgcolor='#CV1' width='100'><a href='/V1'><font size='4'>&nbsp;&nbsp;1&nbsp;&nbsp;</font></td></a><td align='center' bgcolor='#CV2' width='100'><a href='/V2'><font size='4'>&nbsp;&nbsp;2&nbsp;&nbsp;</font></td></a><td align='center' bgcolor='#CV5' width='100'><a href='/V5'><font size='4'>&nbsp;&nbsp;5&nbsp;&nbsp;</font></td></a><td align='center' bgcolor='#CV8' width='100'><a href='/V8'><font size='4'>&nbsp;&nbsp;8&nbsp;&nbsp;</font></td></a><td align='center' bgcolor='#C10' width='100'><a href='/V10'><font size='4'>&nbsp;&nbsp;10&nbsp;&nbsp;</font></td></a><td align='center' bgcolor='#C12' width='100'><a href='/V12'><font size='4'>&nbsp;&nbsp;12&nbsp;&nbsp;</font></td></a></tr><tr><td colspan='6' align='center'>&nbsp;</td></tr><tr><td colspan='6' align='center' bgcolor='#CCFF99'><p align='center'><font size='2'><b>DIREÇÃO</b></font></td></tr><tr><td colspan='3' align='center' bgcolor='#CDE' width='300'><a href='/DE'><font size='4'>&nbsp;&nbsp;&nbsp;&nbsp;ESQUERDA&nbsp;&nbsp;&nbsp;&nbsp;</font></td></a><td colspan='3' align='center' bgcolor='#CDD' width='300'><a href='/DD'><font size='4'>&nbsp;&nbsp;&nbsp;&nbsp;DIREITA&nbsp;&nbsp;&nbsp;&nbsp;</font></td></a></tr><tr><td colspan='6' align='center'>&nbsp;</td></tr><tr><td colspan='6' align='center' bgcolor='#99CCFF'><p align='center'><font size='2'><b>MOVIMENTO</b></font></td></tr><tr><td align='center' bgcolor='#C15' width='100'><a href='/C15'><font size='4'>&nbsp;15º&nbsp;</font></td></a><td align='center' bgcolor='#C30' width='100'><a href='/C30'><font size='4'>&nbsp;30º&nbsp;</font></td></a><td align='center' bgcolor='#C45' width='100'><a href='/C45'><font size='4'>&nbsp;45º&nbsp;</font></td></a><td align='center' bgcolor='#C90' width='100'><a href='/C90'><font size='4'>&nbsp;90º&nbsp;</font></td></a><td align='center' bgcolor='#C18' width='100'><a href='/C18'><font size='2'>&nbsp;180º&nbsp;</font></td></a><td align='center' bgcolor='#CCP' width='100'><a href='/CCP'><font size='2'>ANDA<br>PARA</font></td></a></tr><tr><td colspan='6' align='center'><p align='center'><br><a href='/ini'>INIFLASH</a><br>Depois de clicar em INIFLASH, conectar na rede X28BYJ48, senha 00000000<br> Acessar 192.168.4.1 para escolher a rede a ser utilizada</p></td></tr></table></body></html>";
String copyhtml;
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /ini") >= 0) {
              ...
              x.stopStep();x.stopLed();x.stopBeep();
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            if (currentLine.startsWith("GET /ok?rede=")) //se recebeu n.rede e senha, grava EEPROM e finaliza
            {
              ...
              x.stopStep();x.stopBeep();x.stopLed();
              delay(1000);ESP.restart();
            }  
